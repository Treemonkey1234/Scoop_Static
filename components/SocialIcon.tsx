...
export default function SocialIcon({ platform, size = 24, className = "" }: SocialIconProps) {
  ...
  const svgMapping: { [key: string]: string } = {
    'Google': 'google-icon-logo-svgrepo-com.svg',
    'Spotify': 'spotify-svgrepo-com.svg',
    'Snapchat': 'snapchat-logo-svgrepo-com.svg',
    'Signal': 'signal-svgrepo-com.svg',
    'Steam': 'steam-svgrepo-com.svg',
    'Pinterest': 'pintrest-svgrepo-com.svg',
    'Telegram': 'telegram-svgrepo-com.svg',
    'Fitbit': 'fitbit-logo-svgrepo-com.svg',
    'PayPal': 'paypal-svgrepo-com.svg',
    'Clubhouse': 'clubhouse-svgrepo-com.svg',
    'BeReal': 'bereal-svgrepo-com.svg'
  }

  // Check if we have a custom SVG for this platform
  const svgFileName = svgMapping[platform]
  
  if (svgFileName) {
    return (
      <Image
        src={`/icons/social/${svgFileName}`}
        alt={`${platform} icon`}
        width={size}
        height={size}
        className={className}
  ...
  // Fallback to inline SVG for platforms not in our collection
  const getInlineSVG = () => {
    switch (platform) {
      case 'Facebook':
        return (
      ...
      case 'Twitter':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#1DA1F2" className={className}>
      ...
      case 'GitHub':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#333" className={className}>
      ...
      case 'TikTok':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#000" className={className}>
      ...
      case 'Microsoft':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#00A4EF" className={className}>
      ...
      case 'Okta':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#007DC1" className={className}>
      ...
      case 'ID.me':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#1E88E5" className={className}>
      ...
      case 'IDPartner':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="#6B46C1" className={className}>
            <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none"/>
