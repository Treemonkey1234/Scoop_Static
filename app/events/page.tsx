        ...
        <div className="relative mb-4 -mx-6 -mt-6">
          ...
          <div className="absolute top-4 left-4 flex flex-col space-y-2">
            {event.isPrivate ? (
              ...
              <div className="bg-primary-500/80 backdrop-blur-sm text-white px-3 py-1 rounded-full flex items-center space-x-1">
        ...
        <div className="mb-4">
          ...
          <div className="space-y-2 text-sm text-slate-600">
            ...
            {event.trustRequirement > 0 && (
              <div className="flex items-center space-x-2">
                <span className="w-4 h-4 text-primary-500 text-center">⭐</span>
          ...
          {activeTab === 'discover' && (
            <div className="space-y-4">
              <div className="card-soft text-center py-8">
                <GlobeAltIcon className="w-16 h-16 text-primary-300 mx-auto mb-4" />
